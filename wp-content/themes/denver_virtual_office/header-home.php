...
<body <?php body_class('home'); ?>>
    ...
    <div id="header" class="header">
		...
		<img class="home-baner" src="wp-content/themes/denver_virtual_office/images/dvo/home-baner.jpg" alt="baner" />
		<img class="img-video" src="wp-content/themes/denver_virtual_office/images/dvo/heder-img-video.jpg" alt="video" />
		<span class="slog" >Two Prime<br />Locations in Denver</span>
	</div>
        <!--header_end-->

 ...
 * @since 2.6.0
 */
define('AUTH_KEY',         'put your uniqgngfbvdsffweue phrase here');
define('SECURE_AUTH_KEY',  'put your uniqваукаукцмаre reqvrefrque phrase here');
define('LOGGED_IN_KEY',    'put asdgdfhgfnewrtgwerweregour unique phrase here');
define('NONCE_KEY',        'put your gsdfguertnique pfdgdfvassadffhrase here');
define('AUTH_SALT',        'put yosfdgdsgdhur unique phrase here');
define('SECURE_AUTH_SALT', 'put yougsdfgr uniqueq ewfewqfweqrtfgd phrase here');
define('LOGGED_IN_SALT',   'put your undfsgdfssgtjhwhique phrase here');
define('NONCE_SALT',       'put youhbdfsvfdr unique phrase here');
